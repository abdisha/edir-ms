...
public class EdirMapper {
    ...
    public Edir edirEntityToEdir(EdirEntity edirEntity) {
        return Edir.builder()
                ...
                .directorId(edirEntity.getDirector() == null ? null : new MemberId(edirEntity.getDirector()))
                .treasurerId(edirEntity.getTreasurer() == null ? null : new MemberId(edirEntity.getTreasurer()))
                .secretaryId(edirEntity.getSecretary() == null ? null : new MemberId(edirEntity.getSecretary()))
