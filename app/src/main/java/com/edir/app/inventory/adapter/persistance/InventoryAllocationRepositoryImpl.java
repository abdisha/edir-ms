...
record InventoryAllocationRepositoryImpl(JpaInventoryAllocationRepository allocationRepository,
    ...
    @Override
    public Optional<Allocation> findByAllocationId(UUID allocationId) {
        return allocationRepository.findById(allocationId)
            .map(mapper::inventoryAllocationEntityToInventoryAllocation);
    }

    @Override
    public Optional<Allocation> findByMemberIdAndItemId(UUID memberId, UUID itemId) {
    ...
    @Override
    public List<Allocation> findByMemberId(UUID memberId) {
    ...
    @Override
    public List<Allocation> findByItemId(UUID itemId) {
