...
export default function EventPage() {
    ...
    if (isLoading || meetingEvents.isLoading) {
    ...
    return (
        <div className="space-y-8">
            ...
            <Card className="p-4">
                <Tabs defaultValue="funeral-events">
                    <TabsList className="grid  grid-cols-2">
                        <TabsTrigger value="funeral-events">
                            <HeartHandshake className="mr-2 h-4 w-4"/>
                            Funeral Events
                        </TabsTrigger>
                        <TabsTrigger value="meeting-events">
                            <Users className="mr-2 h-4 w-4"/>
                            Meeting Events
                        </TabsTrigger>
                    </TabsList>

                    <TabsContent value="funeral-events" className="mt-4">
                        <FuneralEventTable funeralEvents={data}
                                           onSelect={funeralId => navigate(`/${funeralId}/funeral-event-detail`)}/>
                    </TabsContent>

                    <TabsContent value="meeting-events" className="mt-4">
                        <MeetingEventTable data={meetingEvents.data}
                                           onSelect={meetingId => navigate(`/${meetingId}/meeting-event-detail`)}
                                           loading={meetingEvents.isLoading}/>
                    </TabsContent>
                </Tabs>
            </Card>
