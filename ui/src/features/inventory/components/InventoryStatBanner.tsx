            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <Card className="border-border/50 shadow-xs bg-card">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        ...
                        <div
                            className="h-8 w-8 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-600">
                ...
                <Card className="border-border/50 shadow-xs bg-card">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        ...
                        <div
                            className="h-8 w-8 rounded-full bg-rose-500/10 flex items-center justify-center text-rose-600">
